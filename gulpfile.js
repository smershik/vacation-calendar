...
gulp.task('libs', function() {
  ...
  gulp.src(bc+'moment/min/**/*.*')
    .pipe(gulp.dest('./builds/dist/libs/moment/'));

  gulp.src(bc+'lodash/dist/**/*.*')
    .pipe(gulp.dest('./builds/dist/libs/lodash/'));

  gulp.src(bc+'angular-moment-picker/dist/**/*.*')
    .pipe(gulp.dest('./builds/dist/libs/angular-moment-picker/'));
  ...
  gulp.src([bc+'angular/angular.js',
            ...
            bc+'angular-local-storage/dist/angular-local-storage.js'
          ])
